function [update_state, L_struct] = reconnect(label, new_six, L_struct, search_size, update_state, layer_n)
...
if label == 76
    ...
    unique_label = unique(canvas .* new_six(:,:,layer_n));
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                  ...
                  bt_angle = -0.5;
                  bt_distance = 3; %%%parameter seting
                  vD = zeros(4,4);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%                 
