...
def setup_slurm_script(args):
  ...
  unet_script_path = os.path.join(self_dir, 'dsc_segmentation.py') 
  sbatch_flags = ["-N 1",
                "-c 4",
                "--mem=16000",
                "--partition=gpu",
...
#  segment_command =("docker run --gpus all -v /mnt/focus stromdock " + "python3" + " " + "-u" + " " + unet_script_path + " " +
#                   "-m" + " " + mode + " " + 
#                   "-i" + " " + input_path + " " + 
#                   "-o" + " " + output_path + " " +
#                   "-w" + " " + weights_path + " " +
...
#                   "-dt" + " " + convertTuple(data_type))
  ...
  segment_command = ["docker","run","--gpus","all","-v","/mnt/focus:/mnt/focus", "stromdock",
	           "python", "-u", unet_script_path, 
                   "-m", mode, 
                   "-i", input_path, 
                   "-o", output_path,
                   "-w", weights_path,
